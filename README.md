# Web сервер который возвращает текущее время сервера UTC. Опционально сервер принимает названия городов, населенных пунктов, и показывает текущее время для них.
